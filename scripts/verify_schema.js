...
const REQUIRED = {
  ...
  commands: ['hash', 'content', 'usage', 'last_used_at'],
  app_state: ['id', 'custom_commands_revision', 'phish_gg_last_sync_at', 'phish_gg_last_sync_status', 'phish_gg_last_sync_summary'],
  ...
  pending_invites: ['id', 'status', 'reviewed_by', 'queue_message_id', 'moderation_history_id', 'created_at'],
  pending_image_reviews: ['id', 'status', 'reviewed_by', 'queue_message_id', 'moderation_history_id', 'home_guild_id', 'author_id'],
  ...
  attention_requests: [
    ...
    'archive_channel_id',
    'archived_at',
    'moderation_history_id',
  ],
  moderation_review_history: [
    'id',
    'guild_id',
    'event_type',
    'subject_type',
