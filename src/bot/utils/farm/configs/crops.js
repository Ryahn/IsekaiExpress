...
const crops = {
	...
	catnip: {
		name: 'Lerd0 Catnip (catnip)',
		displayName: '🌿 Lerd0 Catnip (catnip)',
		yield: 189,
		growthTime: 12 * 60 * 60 * 1000,
	},
	birbfries: {
		name: 'birb fries (birbfries)',
		displayName: '🍟 birb fries (birbfries)',
		yield: 270,
		growthTime: 18 * 60 * 60 * 1000,
	},
	n7art: {
		name: 'N7 2B Art (n7art)',
		displayName: '🎨 N7 2B Art (n7art)',
		yield: 300,
		growthTime: 20 * 60 * 60 * 1000,
	},
	samai: {
		name: 'Sam AI Training (samai)',
		displayName: '🤖 Sam AI Training (samai)',
		yield: 1700,
